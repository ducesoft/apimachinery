...
`apimachinery` is synced from https://github.com/kubernetes/kubernetes/blob/master/staging/src/github.com/ducesoft/apimachinery.
...
## Things you should *NOT* do
 ...
 2. Directly modify any files under `pkg` in this repo. Those are driven from `k8s.io/kubernetes/staging/src/github.com/ducesoft/apimachinery`.
